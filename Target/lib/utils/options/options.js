...
class Options {
    ...
    setValue(name, value, configPath) {
        ...
        if (typeof oldValue === "undefined")
            oldValue = (0, declaration_1.getDefaultValue)(declaration);
        const converted = (0, declaration_1.convert)(value, declaration, this._i18n, configPath ?? process.cwd(), oldValue);
