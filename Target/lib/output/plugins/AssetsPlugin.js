    ...
    var AssetsPlugin = _classThis = class extends _classSuper {
        ...
        onRenderEnd(event) {
            if (this.owner.theme instanceof DefaultTheme_1.DefaultTheme) {
                ...
                const dest = (0, path_1.join)(event.outputDirectory, "assets");
                (0, fs_1.copySync)((0, path_1.join)(src, "style.css"), (0, path_1.join)(dest, "style.css"));
                const mainJs = (0, fs_1.readFile)((0, path_1.join)(src, "main.js"));
                (0, fs_1.writeFileSync)((0, path_1.join)(dest, "main.js"), [
                    '"use strict";',
