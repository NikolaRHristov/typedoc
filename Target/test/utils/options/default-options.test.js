...
describe("Default Options", () => {
    ...
    describe("Highlighting theme", () => {
        it("Errors if an invalid theme is provided", () => {
            ...
            (0, assert_1.strictEqual)(opts.getValue("lightHighlightTheme"), "github-light");
            (0, assert_1.throws)(() => opts.setValue("darkHighlightTheme", "randomTheme"));
            opts.setValue("darkHighlightTheme", "github-light");
            (0, assert_1.strictEqual)(opts.getValue("darkHighlightTheme"), "github-light");
        });
    });
    describe("sort", () => {
    ...
    describe("markdownItOptions", () => {
        it("Errors if given a non-object", () => {
            (0, assert_1.throws)(() => opts.setValue("markdownItOptions", null));
            (0, assert_1.throws)(() => opts.setValue("markdownItOptions", "bad"));
    ...
    describe("requiredToBeDocumented", () => {
        it("Works with valid values", () => {
            (0, assert_1.doesNotThrow)(() => opts.setValue("requiredToBeDocumented", ["Enum"]));
        });
        it("Throws on invalid values", () => {
            (0, assert_1.throws)(() => opts.setValue("requiredToBeDocumented", ["Enum2"]));
        });
    });
    describe("searchCategoryBoosts", () => {
        it("Should disallow non-objects", () => {
            (0, assert_1.throws)(() => opts.setValue("searchCategoryBoosts", null));
        });
        it("Should disallow non-numbers", () => {
            (0, assert_1.throws)(() => opts.setValue("searchCategoryBoosts", {
                cat: true,
            }));
        });
    });
    describe("searchGroupBoosts", () => {
        it("Should disallow non-objects", () => {
            (0, assert_1.throws)(() => opts.setValue("searchGroupBoosts", null));
        });
        it("Should disallow non-numbers", () => {
            (0, assert_1.throws)(() => opts.setValue("searchGroupBoosts", {
                Enum: true,
            }));
        });
        it("Should allow groups", () => {
            (0, assert_1.doesNotThrow)(() => opts.setValue("searchGroupBoosts", { Enum: 5 }));
        });
    });
    describe("headerLinks", () => {
        ...
        it("Should disallow non-strings", () => {
            (0, assert_1.throws)(() => opts.setValue("navigationLinks", {
                Home: true,
            }));
        });
    });
    describe("sidebarLinks", () => {
        ...
        it("Should disallow non-strings", () => {
            (0, assert_1.throws)(() => opts.setValue("sidebarLinks", {
                Home: true,
            }));
        });
    });
