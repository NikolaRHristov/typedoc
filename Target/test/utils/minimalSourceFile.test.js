...
describe("MinimalSourceFile", () => {
    it("Should do bounds checking", () => {
        const sf = new minimalSourceFile_1.MinimalSourceFile("abc\n123\n4\n5", "");
    ...
    it("Should support calculating lines", () => {
        const sf = new minimalSourceFile_1.MinimalSourceFile("abc\n123\n4\n5", "");
        const check = (s, pos) => (0, assert_1.deepStrictEqual)(sf.getLineAndCharacterOfPosition(sf.text.indexOf(s)), pos);
    ...
    it("#2605 Should handle multiple consecutive newlines", () => {
        ...
        (0, assert_1.deepStrictEqual)(sf.getLineAndCharacterOfPosition(0), { line: 0, character: 0 }); // a
        (0, assert_1.deepStrictEqual)(sf.getLineAndCharacterOfPosition(1), { line: 0, character: 1 }); // \n
        (0, assert_1.deepStrictEqual)(sf.getLineAndCharacterOfPosition(2), { line: 1, character: 0 }); // \n
