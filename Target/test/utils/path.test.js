...
describe("normalizePath", () => {
    ...
    winTest("Returns paths with forward slashes", () => {
        (0, assert_1.equal)((0, utils_1.normalizePath)("test\\test\\another/forward"), "test/test/another/forward");
    });
    ...
    winTest("Checks for unix style paths", () => {
        (0, assert_1.equal)((0, utils_1.normalizePath)("/c/users/you"), "C:/users/you");
    });
