...
describe("Array utils", () => {
	describe("insertPrioritySorted", () => {
		...
		it("works with an empty array", () => {
			(0, assert_1.deepStrictEqual)(
				(0, array_1.insertPrioritySorted)([], item1),
				[item1],
			);
		});
		it("inserts at the start", () => {
			(0, assert_1.deepStrictEqual)(
				(0, array_1.insertPrioritySorted)([item1], item2),
				[item2, item1],
			);
		});
		it("inserts in the middle", () => {
			(0, assert_1.deepStrictEqual)(
				(0, array_1.insertPrioritySorted)([item3, item1], item2),
				[item3, item2, item1],
			);
		});
		it("inserts at the end", () => {
			(0, assert_1.deepStrictEqual)(
				(0, array_1.insertPrioritySorted)([item4, item3], item2),
				[item4, item3, item2],
			);
		});
		it("inserts new items last", () => {
			...
			(0, assert_1.deepStrictEqual)(
				(0, array_1.insertPrioritySorted)([item1], item0),
				[item1, item0],
			);
		});
	});
	describe("insertOrderSorted", () => {
		...
		it("works with an empty array", () => {
			(0, assert_1.deepStrictEqual)(
				(0, array_1.insertOrderSorted)([], item1),
				[item1],
			);
		});
		it("inserts at the start", () => {
			(0, assert_1.deepStrictEqual)(
				(0, array_1.insertOrderSorted)([item2], item1),
				[item1, item2],
			);
		});
		it("inserts in the middle", () => {
			(0, assert_1.deepStrictEqual)(
				(0, array_1.insertOrderSorted)([item1, item3], item2),
				[item1, item2, item3],
			);
		});
		it("inserts at the end", () => {
			(0, assert_1.deepStrictEqual)(
				(0, array_1.insertOrderSorted)([item2, item3], item4),
				[item2, item3, item4],
			);
		});
		it("inserts new items last", () => {
			...
			(0, assert_1.deepStrictEqual)(
				(0, array_1.insertOrderSorted)([item1], item0),
				[item1, item0],
			);
		});
	});
	describe("binaryFindPartition", () => {
		...
		it("works with empty array", () => {
			(0, assert_1.deepStrictEqual)(
				(0, array_1.binaryFindPartition)([], always),
				-1,
			);
		});
		it("works with one item", () => {
			(0, assert_1.deepStrictEqual)(
				(0, array_1.binaryFindPartition)([1], always),
				0,
			);
		});
		it("works with more items", () => {
			(0, assert_1.deepStrictEqual)(
				(0, array_1.binaryFindPartition)([1, 2, 3], (n) => n > 2),
				2,
			);
			(0, assert_1.deepStrictEqual)(
				(0, array_1.binaryFindPartition)(
					[1, 2, 3, 4, 5, 6, 7],
					(n) => n > 5,
				),
				5,
		...
		it("works with no partition", () => {
			(0, assert_1.deepStrictEqual)(
				(0, array_1.binaryFindPartition)([1, 2, 3], () => false),
				-1,
			);
		});
		it("works with big arrays", () => {
			...
			const arr = Array.from({ length: 1e5 })
				...
				.fill(1, index);
			(0, assert_1.deepStrictEqual)(
				(0, array_1.binaryFindPartition)(arr, (v) => v === 1),
				index,
			);
		});
	});
	describe("removeIfPresent", () => {
		it("Supports a missing array", () => {
			(0, assert_1.doesNotThrow)(() =>
				(0, array_1.removeIfPresent)(undefined, true),
			);
		});
