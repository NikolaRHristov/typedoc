...
describe("JSX", () => {
	it("Works with basic case", () => {
		const element = utils_1.JSX.createElement(
			"details",
			{ "data-a": "foo", open: true },
			"Text",
		);
		(0, assert_1.deepStrictEqual)(
			(0, utils_1.renderElement)(element),
			'<details data-a="foo" open>Text</details>',
		);
	});
	it("Escapes string content", () => {
		(0, assert_1.deepStrictEqual)(
			(0, utils_1.renderElement)(
				utils_1.JSX.createElement("div", null, "<>"),
			),
			"<div>&lt;&gt;</div>",
		);
	});
	...
	it("Supports component functions", () => {
		const Component = (props) =>
			utils_1.JSX.createElement("span", null, props.text);
		(0, assert_1.deepStrictEqual)(
			(0, utils_1.renderElement)(
	...
	it("Recognizes void elements", () => {
		(0, assert_1.deepStrictEqual)(
			(0, utils_1.renderElement)(
				utils_1.JSX.createElement("div", { id: "main" }),
			),
			'<div id="main"></div>',
		);
	});
	it("Does not render null or undefined attributes", () => {
		(0, assert_1.deepStrictEqual)(
			(0, utils_1.renderElement)(
				utils_1.JSX.createElement("div", { "data-foo": null }),
			),
			"<div></div>",
		);
		(0, assert_1.deepStrictEqual)(
			(0, utils_1.renderElement)(
				utils_1.JSX.createElement("div", { "data-foo": void 0 }),
			),
			"<div></div>",
		);
	});
	it("Handles false boolean attributes", () => {
		(0, assert_1.deepStrictEqual)(
			(0, utils_1.renderElement)(
				utils_1.JSX.createElement("details", { open: false }),
			),
			"<details></details>",
		);
	});
		...
		(0, assert_1.deepStrictEqual)(
			(0, utils_1.renderElement)(
				utils_1.JSX.createElement(
					...
					utils_1.JSX.createElement("div", null, "B"),
				),
			),
			"<div>A</div><div>B</div>",
		);
	...
	it("Supports <Raw /> for injecting HTML", () => {
		(0, assert_1.deepStrictEqual)(
			(0, utils_1.renderElement)(
				utils_1.JSX.createElement(utils_1.Raw, {
		...
		(0, assert_1.deepStrictEqual)(
			(0, utils_1.renderElement)(
				utils_1.JSX.createElement(
					...
					utils_1.JSX.createElement("path", { d: "M 10,30" }),
				),
			),
	...
	it("Properly escapes quotes in html attributes", () => {
		...
		(0, assert_1.deepStrictEqual)(
			(0, utils_1.renderElement)(
				utils_1.JSX.createElement("div", { "data-foo": quot }),
			),
			`<div data-foo="test&quot;quote"></div>`,
		);
	});
});
