...
describe("Options", () => {
	...
	it("Errors if setting flags to an invalid value", () => {
		...
		(0, assert_1.throws)(() =>
			options.setValue("validation", { notExported: "bad" }),
		);
	});
	it("Errors if setting a flag which does not exist", () => {
		(0, assert_1.throws)(() =>
			options.setValue("validation", { doesNotExist: true }),
		);
	});
		...
		return (
			(_a = class Container {
				constructor(options) {
					...
					_Container_emit_accessor_storage.set(
						this,
						__runInitializers(this, _emit_initializers, void 0),
					);
				...
				get emit() {
					return __classPrivateFieldGet(
						this,
						_Container_emit_accessor_storage,
						"f",
					);
				}
				set emit(value) {
