...
describe("loadPlugins", () => {
    ...
    it("Should support loading a ESM plugin", async () => {
        ...
        try {
            ...
            project.write();
            const plugin = (0, path_1.join)((0, path_1.resolve)(project.cwd), "index.js");
            await (0, plugins_1.loadPlugins)(fakeApp, [plugin]);
            logger.expectMessage(`info: Loaded plugin ${plugin}`);
        }
        catch (e_2) {
    ...
    it("Should handle errors when loading plugins", async () => {
        ...
        try {
            ...
            project.addFile("index.js", "exports.load = function load() { throw Error('bad') }");
            project.write();
            const plugin = (0, path_1.join)((0, path_1.resolve)(project.cwd), "index.js");
            await (0, plugins_1.loadPlugins)(fakeApp, [plugin]);
            logger.expectMessage(`error: The plugin ${plugin} could not be loaded`);
    ...
    it("Should handle plugins without a load method", async () => {
        ...
        try {
            ...
            const plugin = (0, path_1.join)((0, path_1.resolve)(project.cwd), "index.js");
            await (0, plugins_1.loadPlugins)(fakeApp, [plugin]);
            logger.expectMessage(`error: Invalid structure in plugin ${plugin}, no load function found`);
        }
        catch (e_5) {
            env_5.error = e_5;
            env_5.hasError = true;
