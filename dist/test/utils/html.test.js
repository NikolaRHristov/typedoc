...
describe("HtmlAttributeParser", () => {
	...
	function stateStr(state) {
		return {
			...
			[html_1.ParserState.BeforeAttributeValue]:
	...
	it("Handles an unterminated double quoted attribute value", () => {
		(0, assert_1.deepStrictEqual)(parse(' a="x'), [
			[State.BeforeAttributeValue, "a", ""],
		]);
	});
	...
	it("Handles character references in unquoted attributes", () => {
		(0, assert_1.deepStrictEqual)(
			parseAttrsToObject(" a=&amp;a b=&amp c=&ampoops >"),
			{
				a: "&a",
				b: "&",
				c: "&ampoops",
	...
	it("Handles simple numeric character references", () => {
		(0, assert_1.deepStrictEqual)(
			parseAttrsToObject("a=&#97; b=&#x5A; c=&#X5a;"),
			{
				a: "a",
				b: "Z",
				c: "Z",
	...
	it("Handles invalid characters in numeric character references", () => {
		...
		(0, assert_1.deepStrictEqual)(
			parseAttrsToObject("a='rng:&#x11ffff;x'>"),
			{
				a: "rng:\ufffdx",
			},
		);
		(0, assert_1.deepStrictEqual)(
			parseAttrsToObject("a='leading surrogate:&#xd801;x'>"),
			{
				a: "leading surrogate:\ufffdx",
			},
		);
		(0, assert_1.deepStrictEqual)(
			parseAttrsToObject("a='trailing surrogate:&#xdc01;x'>"),
			{
