 ...
 */
let SourcePlugin = (() => {
	var _SourcePlugin_disableSources_accessor_storage,
		_SourcePlugin_gitRevision_accessor_storage,
		_SourcePlugin_gitRemote_accessor_storage,
		_SourcePlugin_disableGit_accessor_storage,
		_SourcePlugin_sourceLinkTemplate_accessor_storage,
		_SourcePlugin_basePath_accessor_storage;
	...
	var SourcePlugin = (_classThis = class extends _classSuper {
		constructor() {
			super(...arguments);
			_SourcePlugin_disableSources_accessor_storage.set(
				this,
				__runInitializers(this, _disableSources_initializers, void 0),
			);
			_SourcePlugin_gitRevision_accessor_storage.set(
				this,
				(__runInitializers(this, _disableSources_extraInitializers),
				__runInitializers(this, _gitRevision_initializers, void 0)),
			);
			_SourcePlugin_gitRemote_accessor_storage.set(
				this,
				(__runInitializers(this, _gitRevision_extraInitializers),
				__runInitializers(this, _gitRemote_initializers, void 0)),
			);
			_SourcePlugin_disableGit_accessor_storage.set(
				this,
				(__runInitializers(this, _gitRemote_extraInitializers),
				__runInitializers(this, _disableGit_initializers, void 0)),
			);
			_SourcePlugin_sourceLinkTemplate_accessor_storage.set(
				this,
				(__runInitializers(this, _disableGit_extraInitializers),
				__runInitializers(
					this,
					_sourceLinkTemplate_initializers,
					void 0,
				)),
			);
			_SourcePlugin_basePath_accessor_storage.set(
				this,
				(__runInitializers(this, _sourceLinkTemplate_extraInitializers),
				__runInitializers(this, _basePath_initializers, void 0)),
			);
			/**
			 * All file names to find the base path from.
			 */
			this.fileNames =
				(__runInitializers(this, _basePath_extraInitializers),
				new Set());
		}
		get disableSources() {
			return __classPrivateFieldGet(
				this,
				_SourcePlugin_disableSources_accessor_storage,
				"f",
			);
		}
		set disableSources(value) {
		...
		onDeclaration(_context, reflection) {
			...
			for (const node of symbol?.declarations || []) {
				...
				const fileName = (0, utils_1.normalizePath)(
					sourceFile.fileName,
				);
				...
				if (typescript_1.default.isSourceFile(node)) {
					...
					position =
						typescript_1.default.getLineAndCharacterOfPosition(
							sourceFile,
		...
		onSignature(_context, reflection, sig) {
			...
			this.fileNames.add(fileName);
			const position = typescript_1.default.getLineAndCharacterOfPosition(
				sourceFile,
		...
		onBeginResolve(context) {
			...
			const basePath =
				this.basePath ||
				(0, utils_1.getCommonDirectory)([...this.fileNames]);
			this.repositories ||= new repository_1.RepositoryManager(
				basePath,
				this.gitRevision,
				this.gitRemote,
			...
			for (const id in context.project.reflections) {
				...
				if (
					!(
						refl instanceof index_1.DeclarationReflection ||
				...
				for (const source of refl.sources || []) {
					if (this.disableGit || (0, repository_1.gitIsInstalled)()) {
						...
						source.url = repo?.getURL(
							source.fullFileName,
							source.line,
						);
					}
					source.fileName = (0, utils_1.normalizePath)(
						(0, path_1.relative)(basePath, source.fullFileName),
					);
				}
			}
		}
	...
	(() => {
		...
		_sourceLinkTemplate_decorators = [
			(0, utils_1.Option)("sourceLinkTemplate"),
		];
		_basePath_decorators = [(0, utils_1.Option)("basePath")];
		__esDecorate(
			_classThis,
			null,
			_disableSources_decorators,
			{
				kind: "accessor",
				name: "disableSources",
				static: false,
				private: false,
				access: {
					has: (obj) => "disableSources" in obj,
					get: (obj) => obj.disableSources,
					set: (obj, value) => {
						obj.disableSources = value;
					},
				},
				metadata: _metadata,
			},
			_disableSources_initializers,
			_disableSources_extraInitializers,
		);
		__esDecorate(
			_classThis,
			null,
			_gitRevision_decorators,
			{
				kind: "accessor",
				name: "gitRevision",
				static: false,
				private: false,
				access: {
					has: (obj) => "gitRevision" in obj,
					get: (obj) => obj.gitRevision,
					set: (obj, value) => {
						obj.gitRevision = value;
					},
				},
				metadata: _metadata,
			},
			_gitRevision_initializers,
			_gitRevision_extraInitializers,
		);
		__esDecorate(
			_classThis,
			null,
			_gitRemote_decorators,
			{
				kind: "accessor",
				name: "gitRemote",
				static: false,
				private: false,
				access: {
					has: (obj) => "gitRemote" in obj,
					get: (obj) => obj.gitRemote,
					set: (obj, value) => {
						obj.gitRemote = value;
					},
				},
			...
			_gitRemote_initializers,
			_gitRemote_extraInitializers,
		);
		__esDecorate(
			_classThis,
			null,
			_disableGit_decorators,
			{
				kind: "accessor",
				name: "disableGit",
				static: false,
				private: false,
				access: {
					has: (obj) => "disableGit" in obj,
					get: (obj) => obj.disableGit,
					set: (obj, value) => {
						obj.disableGit = value;
					},
				},
				metadata: _metadata,
			},
			_disableGit_initializers,
			_disableGit_extraInitializers,
		);
		__esDecorate(
			_classThis,
			null,
			_sourceLinkTemplate_decorators,
			{
				...
				private: false,
				access: {
					has: (obj) => "sourceLinkTemplate" in obj,
					get: (obj) => obj.sourceLinkTemplate,
					set: (obj, value) => {
						obj.sourceLinkTemplate = value;
					},
				},
				metadata: _metadata,
			},
		...
		__esDecorate(
			...
			_basePath_decorators,
			{
				...
				private: false,
				access: {
					has: (obj) => "basePath" in obj,
					get: (obj) => obj.basePath,
					set: (obj, value) => {
						obj.basePath = value;
					},
				},
			...
			_basePath_initializers,
			_basePath_extraInitializers,
		);
		__esDecorate(
			null,
...
function getLocationNode(node) {
	if ((0, nodes_1.isNamedNode)(node)) return node.name;
	return node;
}
