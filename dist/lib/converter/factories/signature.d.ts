 ...
 */
export declare function createConstructSignatureWithType(
	context: Context,
	signature: ts.Signature,
	classType: Reflection,
): void;
export declare function convertParameterNodes(
	context: Context,
	sigRef: SignatureReflection,
	parameters: readonly (ts.JSDocParameterTag | ts.ParameterDeclaration)[],
): ParameterReflection[];
export declare function convertTypeParameterNodes(
	context: Context,
	parameters: readonly ts.TypeParameterDeclaration[] | undefined,
): TypeParameterReflection[] | undefined;
export declare function createTypeParamReflection(
	param: ts.TypeParameterDeclaration,
	context: Context,
): TypeParameterReflection;
export declare function convertTemplateParameterNodes(
	context: Context,
