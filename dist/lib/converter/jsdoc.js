...
function convertJsDocSignature(context, node) {
	...
	signature.typeParameters = (0, signature_1.convertTemplateParameterNodes)(
		context.withScope(reflection),
		node.typeParameters,
	);
...
function convertTemplateParameters(context, node) {
	...
	context.scope.typeParameters = (0,
	signature_1.convertTemplateParameterNodes)(
		context,
		node.tags?.filter(typescript_1.default.isJSDocTemplateTag),
	);
}
function getTypedefReExportTarget(context, declaration) {
	...
	const targetParams =
		typescript_1.default.getEffectiveTypeParameterDeclarations(decl);
	const localParams =
		typescript_1.default.getEffectiveTypeParameterDeclarations(declaration);
	...
	if (
		...
		localArgs.some(
			(arg, i) =>
				!typescript_1.default.isTypeReferenceNode(arg) ||
