...
export declare function getNodeComment(
	node: ts.Node,
...
export declare function getFileComment(
	file: ts.SourceFile,
	config: CommentParserConfig,
	logger: Logger,
	checker: ts.TypeChecker | undefined,
...
export declare function getSignatureComment(
...
export declare function getJsDocComment(
	declaration:
