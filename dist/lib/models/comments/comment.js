	...
	return (
		(_a = class Comment {
						...
						case "inline-tag": {
							if (typeof part.target === "number") {
								...
								return {
									...
									tag: part.tag,
									text: part.text,
									target: new ReflectionSymbolId_1.ReflectionSymbolId(
										part.target,
									),
									tsLinkText: part.tsLinkText,
								};
			...
			constructor(
				 ...
				 */
				this.sourcePath = __runInitializers(
					this,
					_sourcePath_initializers,
					void 0,
				);
				/**
				 ...
				 */
				this.discoveryId =
					(__runInitializers(this, _sourcePath_extraInitializers),
					__runInitializers(this, _discoveryId_initializers, void 0));
				/**
				...
				this.inheritedFromParentDeclaration =
					...
					__runInitializers(
						this,
						_inheritedFromParentDeclaration_initializers,
						void 0,
					));
				__runInitializers(
					this,
					_inheritedFromParentDeclaration_extraInitializers,
				);
			...
			similarTo(other) {
				if (
					_a.combineDisplayParts(this.summary) !==
			 ...
			 */
			clone() {
				const comment = new _a(
					_a.cloneDisplayParts(this.summary),
			...
			isEmpty() {
				return (
					!this.hasVisibleComponent() && this.modifierTags.size === 0
				);
			}
			/**
		...
		(() => {
			...
			_inheritedFromParentDeclaration_decorators = [
				general_1.NonEnumerable,
			];
			__esDecorate(
				null,
				null,
				_sourcePath_decorators,
				{
					kind: "field",
					name: "sourcePath",
					static: false,
				...
				_sourcePath_initializers,
				_sourcePath_extraInitializers,
			);
			__esDecorate(
				null,
				null,
				_discoveryId_decorators,
				{
					kind: "field",
					name: "discoveryId",
					static: false,
				...
				_discoveryId_initializers,
				_discoveryId_extraInitializers,
			);
			__esDecorate(
				null,
				null,
