...
(function (ReflectionKind) {
	...
	ReflectionKind[(ReflectionKind["IndexSignature"] = 8192)] =
		"IndexSignature";
	ReflectionKind[(ReflectionKind["ConstructorSignature"] = 16384)] =
		"ConstructorSignature";
	ReflectionKind[(ReflectionKind["Parameter"] = 32768)] = "Parameter";
	ReflectionKind[(ReflectionKind["TypeLiteral"] = 65536)] = "TypeLiteral";
	ReflectionKind[(ReflectionKind["TypeParameter"] = 131072)] =
		"TypeParameter";
...
(function (ReflectionKind) {
	...
	/** @internal */
	ReflectionKind.MayContainDocuments =
		ReflectionKind.SomeExport |
	...
	ReflectionKind.Inheritable =
		...
		ReflectionKind.Constructor;
	/** @internal */
	ReflectionKind.ContainsCallSignatures =
		ReflectionKind.Constructor |
		ReflectionKind.Function |
		ReflectionKind.Method;
	 ...
	 * @internal
	 */
	ReflectionKind.SignatureContainer =
		ReflectionKind.ContainsCallSignatures | ReflectionKind.Accessor;
	/** @internal */
	ReflectionKind.VariableContainer =
		ReflectionKind.SomeModule | ReflectionKind.Project;
	/** @internal */
