...
(function (TraverseProperty) {
	...
	TraverseProperty[(TraverseProperty["IndexSignature"] = 6)] =
		"IndexSignature";
	...
	return (
		(_a = class Reflection {
			constructor(name, kind, parent) {
				 ...
				 */
				this.parent = __runInitializers(
					this,
					_parent_initializers,
					void 0,
				);
				this.project =
					(__runInitializers(this, _parent_extraInitializers),
					__runInitializers(this, _project_initializers, void 0));
				/**
				 * The parsed documentation comment attached to this reflection.
				 */
				this.comment = __runInitializers(
					this,
					_project_extraInitializers,
				);
			...
			getFullName(separator = ".") {
				if (this.parent && !this.parent.isProject()) {
					return (
						this.parent.getFullName(separator) +
						separator +
						this.name
					);
				} else {
			...
			hasComment() {
				return this.comment
					? this.comment.hasVisibleComponent()
					: false;
			}
			hasGetterOrSetter() {
				return false;
			...
			isDeprecated() {
				...
				if (
					signaturesDeprecated ||
					this.comment?.getTag("@deprecated")
				) {
					return true;
				}
			...
			fromObject(de, obj) {
				...
				this.comment = de.revive(
					obj.comment,
					() => new comment_1.Comment(),
				);
		...
		(() => {
			const _metadata =
				typeof Symbol === "function" && Symbol.metadata
					...
					: void 0;
			_parent_decorators = [
				general_1.NonEnumerable, // So that it doesn't show up in console.log
			];
