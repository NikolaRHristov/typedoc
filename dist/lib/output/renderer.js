 ...
 */
let Renderer = (() => {
	var _Renderer_themeName_accessor_storage,
		_Renderer_cleanOutputDir_accessor_storage,
		_Renderer_cname_accessor_storage,
		_Renderer_githubPages_accessor_storage,
		_Renderer_cacheBust_accessor_storage,
		_Renderer_lightTheme_accessor_storage,
		_Renderer_darkTheme_accessor_storage,
		_Renderer_highlightLanguages_accessor_storage,
		_Renderer_pretty_accessor_storage;
	...
	var Renderer = (_classThis = class extends _classSuper {
		constructor() {
			super(...arguments);
			this.themes = new Map([["default", DefaultTheme_1.DefaultTheme]]);
			/**
			...
			_Renderer_themeName_accessor_storage.set(
				this,
				__runInitializers(this, _themeName_initializers, void 0),
			);
			_Renderer_cleanOutputDir_accessor_storage.set(
				this,
				(__runInitializers(this, _themeName_extraInitializers),
				__runInitializers(this, _cleanOutputDir_initializers, void 0)),
			);
			_Renderer_cname_accessor_storage.set(
				this,
				(__runInitializers(this, _cleanOutputDir_extraInitializers),
				__runInitializers(this, _cname_initializers, void 0)),
			);
			_Renderer_githubPages_accessor_storage.set(
				this,
				(__runInitializers(this, _cname_extraInitializers),
				__runInitializers(this, _githubPages_initializers, void 0)),
			);
			_Renderer_cacheBust_accessor_storage.set(
				this,
				(__runInitializers(this, _githubPages_extraInitializers),
				__runInitializers(this, _cacheBust_initializers, void 0)),
			);
			_Renderer_lightTheme_accessor_storage.set(
				this,
				(__runInitializers(this, _cacheBust_extraInitializers),
				__runInitializers(this, _lightTheme_initializers, void 0)),
			);
			_Renderer_darkTheme_accessor_storage.set(
				this,
				(__runInitializers(this, _lightTheme_extraInitializers),
				__runInitializers(this, _darkTheme_initializers, void 0)),
			);
			_Renderer_highlightLanguages_accessor_storage.set(
				this,
				(__runInitializers(this, _darkTheme_extraInitializers),
				__runInitializers(
					this,
					_highlightLanguages_initializers,
					void 0,
				)),
			);
			_Renderer_pretty_accessor_storage.set(
				this,
				(__runInitializers(this, _highlightLanguages_extraInitializers),
				__runInitializers(this, _pretty_initializers, void 0)),
			);
			this.renderStartTime =
				(__runInitializers(this, _pretty_extraInitializers), -1);
		}
		/** @internal */
		get themeName() {
			return __classPrivateFieldGet(
				this,
				_Renderer_themeName_accessor_storage,
				"f",
			);
		}
		set themeName(value) {
		...
		async runPreRenderJobs(output) {
			...
			await Promise.all(
				this.preRenderAsyncJobs.map((job) => job(output)),
			);
			this.preRenderAsyncJobs = [];
			this.application.logger.verbose(
		...
		async loadHighlighter() {
			await (0, highlighter_1.loadHighlighter)(
				this.lightTheme,
				this.darkTheme,
	...
	(() => {
		...
		_highlightLanguages_decorators = [
			(0, utils_1.Option)("highlightLanguages"),
		];
		_pretty_decorators = [(0, utils_1.Option)("pretty")];
		__esDecorate(
			_classThis,
			null,
			_themeName_decorators,
			{
				kind: "accessor",
				name: "themeName",
				static: false,
				private: false,
				access: {
					has: (obj) => "themeName" in obj,
					get: (obj) => obj.themeName,
					set: (obj, value) => {
						obj.themeName = value;
					},
				},
			...
			_themeName_initializers,
			_themeName_extraInitializers,
		);
		__esDecorate(
			_classThis,
			null,
			_cleanOutputDir_decorators,
			{
				kind: "accessor",
				name: "cleanOutputDir",
				static: false,
				private: false,
				access: {
					has: (obj) => "cleanOutputDir" in obj,
					get: (obj) => obj.cleanOutputDir,
					set: (obj, value) => {
						obj.cleanOutputDir = value;
					},
				},
				metadata: _metadata,
			},
			_cleanOutputDir_initializers,
			_cleanOutputDir_extraInitializers,
		);
		__esDecorate(
			_classThis,
			null,
			...
			_cname_initializers,
			_cname_extraInitializers,
		);
		__esDecorate(
			_classThis,
			null,
			_githubPages_decorators,
			{
				kind: "accessor",
				name: "githubPages",
				static: false,
				private: false,
				access: {
					has: (obj) => "githubPages" in obj,
					get: (obj) => obj.githubPages,
					set: (obj, value) => {
						obj.githubPages = value;
					},
				},
				metadata: _metadata,
			},
			_githubPages_initializers,
			_githubPages_extraInitializers,
		);
		__esDecorate(
			_classThis,
			null,
			_cacheBust_decorators,
			{
				kind: "accessor",
				name: "cacheBust",
				static: false,
				private: false,
				access: {
					has: (obj) => "cacheBust" in obj,
					get: (obj) => obj.cacheBust,
					set: (obj, value) => {
						obj.cacheBust = value;
					},
				},
			...
			_cacheBust_initializers,
			_cacheBust_extraInitializers,
		);
		__esDecorate(
			_classThis,
			null,
			_lightTheme_decorators,
			{
				kind: "accessor",
				name: "lightTheme",
				static: false,
				private: false,
				access: {
					has: (obj) => "lightTheme" in obj,
					get: (obj) => obj.lightTheme,
					set: (obj, value) => {
						obj.lightTheme = value;
					},
				},
				metadata: _metadata,
			},
			_lightTheme_initializers,
			_lightTheme_extraInitializers,
		);
		__esDecorate(
			_classThis,
			null,
			_darkTheme_decorators,
			{
				kind: "accessor",
				name: "darkTheme",
				static: false,
				private: false,
				access: {
					has: (obj) => "darkTheme" in obj,
					get: (obj) => obj.darkTheme,
					set: (obj, value) => {
						obj.darkTheme = value;
					},
				},
			...
			_darkTheme_initializers,
			_darkTheme_extraInitializers,
		);
		__esDecorate(
			_classThis,
			null,
			_highlightLanguages_decorators,
			{
				...
				private: false,
				access: {
					has: (obj) => "highlightLanguages" in obj,
					get: (obj) => obj.highlightLanguages,
					set: (obj, value) => {
						obj.highlightLanguages = value;
					},
				},
				metadata: _metadata,
			},
			_highlightLanguages_initializers,
			_highlightLanguages_extraInitializers,
		);
		__esDecorate(
			_classThis,
			null,
			...
			_pretty_initializers,
			_pretty_extraInitializers,
		);
		__esDecorate(
			null,
