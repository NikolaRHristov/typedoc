	...
	var AssetsPlugin = (_classThis = class extends _classSuper {
		...
		get customCss() {
			return __classPrivateFieldGet(
				this,
				_AssetsPlugin_customCss_accessor_storage,
				"f",
			);
		}
		set customCss(value) {
		...
		initialize() {
			this.owner.on(
				...
				this.onRenderBegin.bind(this),
			);
			this.owner.on(
				events_1.RendererEvent.END,
				this.onRenderEnd.bind(this),
			);
		}
		onRenderBegin(event) {
		...
		onRenderEnd(event) {
			if (this.owner.theme instanceof DefaultTheme_1.DefaultTheme) {
				...
				const dest = (0, path_1.join)(event.outputDirectory, "assets");
				(0, fs_1.copySync)(
					(0, path_1.join)(src, "style.css"),
					(0, path_1.join)(dest, "style.css"),
				);
				const mainJs = (0, fs_1.readFile)(
					(0, path_1.join)(src, "main.js"),
				);
				(0, fs_1.writeFileSync)(
					(0, path_1.join)(dest, "main.js"),
					[
						'"use strict";',
				...
				(0, fs_1.writeFileSync)(
					(0, path_1.join)(dest, "highlight.css"),
					(0, highlighter_1.getStyles)(),
				);
		...
		constructor() {
			super(...arguments);
			_AssetsPlugin_customCss_accessor_storage.set(
				this,
				__runInitializers(this, _customCss_initializers, void 0),
			);
	...
	(() => {
		...
		__esDecorate(
			...
			_customCss_decorators,
			{
				...
				private: false,
				access: {
					has: (obj) => "customCss" in obj,
					get: (obj) => obj.customCss,
					set: (obj, value) => {
						obj.customCss = value;
					},
				},
			...
			_customCss_initializers,
			_customCss_extraInitializers,
		);
		__esDecorate(
			null,
