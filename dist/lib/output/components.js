...
exports.ContextAwareRendererComponent =
...
let ContextAwareRendererComponent = (() => {
	var _a,
		_ContextAwareRendererComponent_useHostedBaseUrlForAbsoluteLinks_accessor_storage;
	...
	return (
		(_a = class ContextAwareRendererComponent extends _classSuper {
			constructor() {
				super(...arguments);
				/**
				...
				_ContextAwareRendererComponent_useHostedBaseUrlForAbsoluteLinks_accessor_storage.set(
					this,
					__runInitializers(
						this,
						_useHostedBaseUrlForAbsoluteLinks_initializers,
						void 0,
					),
				);
				this.absoluteToRelativePathMap =
					(__runInitializers(
						this,
						_useHostedBaseUrlForAbsoluteLinks_extraInitializers,
					),
					new Map());
			}
			get hostedBaseUrl() {
			...
			get useHostedBaseUrlForAbsoluteLinks() {
			...
			set useHostedBaseUrlForAbsoluteLinks(value) {
			...
			initialize() {
				this.owner.on(
					...
					this.onBeginRenderer.bind(this),
				);
				this.owner.on(
					events_1.PageEvent.BEGIN,
					this.onBeginPage.bind(this),
				);
				this.owner.on(events_1.RendererEvent.END, () =>
		...
		(() => {
			const _metadata =
				typeof Symbol === "function" && Symbol.metadata
					...
					: void 0;
			_useHostedBaseUrlForAbsoluteLinks_decorators = [
				(0, utils_1.Option)("useHostedBaseUrlForAbsoluteLinks"),
			];
			__esDecorate(
				_a,
				null,
				_useHostedBaseUrlForAbsoluteLinks_decorators,
				{
					...
					private: false,
					access: {
						has: (obj) => "useHostedBaseUrlForAbsoluteLinks" in obj,
						get: (obj) => obj.useHostedBaseUrlForAbsoluteLinks,
						set: (obj, value) => {
							obj.useHostedBaseUrlForAbsoluteLinks = value;
						},
					},
					metadata: _metadata,
				},
