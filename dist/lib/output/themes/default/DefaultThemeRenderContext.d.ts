...
export declare class DefaultThemeRenderContext {
	...
	) => import("../../../utils/jsx.elements").JsxElement;
	reflectionTemplate: (
		props: PageEvent<import("../../../models").ContainerReflection>,
	) => import("../../../utils/jsx.elements").JsxElement;
	indexTemplate: (
		props: PageEvent<import("../../../models").ProjectReflection>,
	) => import("../../../utils/jsx.elements").JsxElement;
	hierarchyTemplate: (
		props: PageEvent<import("../../../models").ProjectReflection>,
	) => import("../../../utils/jsx.elements").JsxElement;
	defaultLayout: (
		template: import("../..").RenderTemplate<PageEvent<Reflection>>,
	...
	reflectionPreview: (
		props: Reflection,
	) => import("../../../utils/jsx.elements").JsxElement | undefined;
	breadcrumb: (
		props: Reflection,
	) => import("../../../utils/jsx.elements").JsxElement | undefined;
	commentSummary: (
	...
	hierarchy: (
		props: import("../../../models").DeclarationHierarchy | undefined,
	) => import("../../../utils/jsx.elements").JsxElement | undefined;
	index: (
		props: import("../../../models").ContainerReflection,
	) => import("../../../utils/jsx.elements").JsxElement;
	member: (
		props: DocumentReflection | DeclarationReflection,
	) => import("../../../utils/jsx.elements").JsxElement;
	memberDeclaration: (
	...
	memberReference: (
		props: import("../../../models").ReferenceReflection,
	) => import("../../../utils/jsx.elements").JsxElement;
	memberSignatureBody: (
		props: import("../../../models").SignatureReflection,
		r_1?:
			| {
					hideSources?: boolean;
			  }
	...
	memberSources: (
		props:
			| DeclarationReflection
			| import("../../../models").SignatureReflection,
	) => import("../../../utils/jsx.elements").JsxElement;
	members: (
		props: import("../../../models").ContainerReflection,
	) => import("../../../utils/jsx.elements").JsxElement;
	...
	type: (
		type: import("../../../models").Type | undefined,
		options?:
			| {
	...
	typeAndParent: (
		props: import("../../../models").Type,
	) => import("../../../utils/jsx.elements").JsxElement;
	typeParameters: (
		typeParameters: import("../../../models").TypeParameterReflection[],
	) => import("../../../utils/jsx.elements").JsxElement;
}
