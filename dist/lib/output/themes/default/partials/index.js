...
function renderCategory(
	{ urlTo, icons, getReflectionClasses, markdown },
	item,
	prependName = "",
) {
	return utils_1.JSX.createElement(
		"section",
		{ class: "tsd-index-section" },
		utils_1.JSX.createElement(
			"h3",
			{ class: "tsd-index-heading" },
...
function index(context, props) {
	...
	if (
		...
		content = utils_1.JSX.createElement(
			"details",
			{ class: "tsd-index-content tsd-accordion", open: true },
			utils_1.JSX.createElement(
				"summary",
	...
	return utils_1.JSX.createElement(
		...
		utils_1.JSX.createElement(
			"section",
			{ class: "tsd-panel-group tsd-index-group" },
			utils_1.JSX.createElement(
				"section",
				{ class: "tsd-panel tsd-index-panel" },
				content,
			),
		),
	);
