...
const kindIcon = (letterPath, color, circular = false) =>
	utils_1.JSX.createElement(
		"svg",
		{ class: "tsd-kind-icon", viewBox: "0 0 24 24" },
		utils_1.JSX.createElement("rect", {
...
function buildRefIcons(icons, context) {
	...
	for (const [name, builder] of Object.entries(icons)) {
		...
		const ref = utils_1.JSX.createElement(
			"svg",
			{ ...jsx.props, id: undefined },
			utils_1.JSX.createElement("use", {
				href: `${context.relativeURL("assets/icons.svg")}#icon-${name}`,
			}),
		);
		refs[name] = () => ref;
	}
...
exports.icons = {
	[models_1.ReflectionKind.Accessor]: () =>
		kindIcon(
			utils_1.JSX.createElement("path", {
	...
	[models_1.ReflectionKind.Document]: () =>
		kindIcon(
			utils_1.JSX.createElement(
				...
				utils_1.JSX.createElement("polygon", {
					points: "6,5 6,19 18,19, 18,9 15,5",
				}),
				utils_1.JSX.createElement("line", {
					x1: "9",
					y1: "9",
					x2: "14",
					y2: "9",
