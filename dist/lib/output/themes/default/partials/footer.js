...
function footer(context) {
	...
	let generatorDisplay = utils_1.JSX.createElement(
	...
	if (!hideGenerator) {
		...
		if (index == -1) {
			generatorDisplay = utils_1.JSX.createElement(
				"p",
				{ class: "tsd-generator" },
				message,
			);
			...
			generatorDisplay = utils_1.JSX.createElement(
				...
				utils_1.JSX.createElement(
					"a",
					{ href: "https://typedoc.org/", target: "_blank" },
					"TypeDoc",
				),
				post,
			);
	...
	let customFooterDisplay = utils_1.JSX.createElement(
		utils_1.JSX.Fragment,
		null,
	);
	if (customFooterHtml) {
		if (context.options.getValue("customFooterHtmlDisableWrapper")) {
			customFooterDisplay = utils_1.JSX.createElement(utils_1.JSX.Raw, {
				html: customFooterHtml,
			});
		} else {
			customFooterDisplay = utils_1.JSX.createElement(
				"p",
				null,
				utils_1.JSX.createElement(utils_1.JSX.Raw, {
					html: customFooterHtml,
				}),
			);
		}
