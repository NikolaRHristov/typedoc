...
function renderingTypeDeclarationIsUseful(declaration) {
	...
	if (declaration.children?.some(renderingTypeDeclarationIsUseful))
		return true;
	if (
		declaration.type?.type === "reflection" &&
...
function memberDeclaration(context, props) {
	...
	return utils_1.JSX.createElement(
		...
		utils_1.JSX.createElement(
			...
			utils_1.JSX.createElement(
				"span",
				{ class: (0, lib_1.getKindClass)(props) },
				(0, lib_1.wbr)(props.name),
			),
			(0, lib_1.renderTypeParametersSignature)(
				context,
						...
						result.push(
							utils_1.JSX.createElement(
								...
								utils_1.JSX.createElement(utils_1.Raw, {
									html: context.markdown(
										union.elementSummaries[i],
									),
								}),
