...
const defaultLayout = (context, template, props) =>
	utils_1.JSX.createElement(
		"html",
		{ class: "default", lang: context.options.getValue("lang") },
		utils_1.JSX.createElement(
			"head",
			null,
			utils_1.JSX.createElement("meta", { charset: "utf-8" }),
			context.hook("head.begin", context),
			utils_1.JSX.createElement("meta", {
			...
			utils_1.JSX.createElement("link", {
				rel: "stylesheet",
			...
			utils_1.JSX.createElement("script", {
				defer: true,
		...
		utils_1.JSX.createElement(
			...
			utils_1.JSX.createElement(
				...
				utils_1.JSX.createElement(utils_1.Raw, {
					html: 'document.body.style.display="none";',
				}),
				utils_1.JSX.createElement(utils_1.Raw, {
					html: 'setTimeout(() => app?app.showPage():document.body.style.removeProperty("display"),500)',
				}),
			),
