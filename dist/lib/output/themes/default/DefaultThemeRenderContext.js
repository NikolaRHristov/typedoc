...
class DefaultThemeRenderContext {
	constructor(theme, page, options) {
		...
		this.getReflectionClasses = (refl) =>
		 ...
		 */
		this.reflectionPreview = bind(
			reflectionPreview_1.reflectionPreview,
			this,
		);
		...
		this.memberDeclaration = bind(
			member_declaration_1.memberDeclaration,
			this,
		);
		this.memberGetterSetter = bind(
			member_getterSetter_1.memberGetterSetter,
			this,
		);
		this.memberReference = bind(member_reference_1.memberReference, this);
		this.memberSignatureBody = bind(
			member_signature_body_1.memberSignatureBody,
			this,
		);
		this.memberSignatureTitle = bind(
			member_signature_title_1.memberSignatureTitle,
			this,
		);
		this.memberSignatures = bind(
			member_signatures_1.memberSignatures,
			this,
		);
