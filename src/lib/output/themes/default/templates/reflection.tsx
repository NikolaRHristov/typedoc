			...
			{props.model instanceof DeclarationReflection && (
				<>
					...
					{!props.model.signatures &&
						context.memberSources(props.model)}
				</>
			)}
...
function renderIndexSignature(
	context: DefaultThemeRenderContext,
	index: SignatureReflection,
) {
	return (
		<li class="tsd-index-signature">
			...
			{index.type instanceof ReflectionType &&
